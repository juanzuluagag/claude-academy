...
export const IDENTITY_SETUP_LESSON = {
  ...
  content: [
    ...
    {
      type: 'cards',
      title: 'Los 5 archivos de contexto personal que todo usuario avanzado necesita',
      items: [
        {
          name: 'Archivo 1: About Me (Quién soy)',
          tag: 'El más importante',
          color: '#6366F1',
          desc: 'Quién eres: tu rol, empresa, industria, proyectos actuales, audiencia. Claude necesita saber quién pregunta antes de poder responder bien. Sin esto, da respuestas para "cualquier profesional genérico".',
        },
        {
          name: 'Archivo 2: Voz y estilo (Cómo escribo)',
          tag: 'Para escritura',
          color: '#10B981',
          desc: 'Tus patrones de escritura: tono, ritmo, vocabulario, estructuras que usas, y los anti-patrones de IA que nunca debes incluir. Diferente a Claude Styles global: este archivo vive en tu Project, no en la configuración de cuenta.',
        },
        {
          name: 'Archivo 3: Decisiones tomadas (Qué ya decidí)',
          tag: 'Para proyectos',
          color: '#F59E0B',
          desc: 'Lo que ya decidiste y no quieres que Claude cuestione: stack tecnológico, gestor de paquetes, arquitectura, librerías descartadas. Evita que Claude proponga alternativas que ya evaluaste y rechazaste.',
        },
        {
          name: 'Archivo 4: Anti-metas (Qué NO quiero)',
          tag: 'Restricciones',
          color: '#EF4444',
          desc: 'Lista de cosas que Claude explícitamente NO debe hacer: no agregar dependencias sin preguntar, no usar CSS-in-JS, no comentarios en inglés si el proyecto es en español. Las restricciones son tan importantes como los objetivos.',
        },
        {
          name: 'Archivo 5: Stakeholders (Quiénes son)',
          tag: 'Para equipos',
          color: '#8B5CF6',
          desc: 'Las personas relevantes en tu contexto: roles, preferencias, estilos de comunicación. Para trabajo en equipo o con clientes recurrentes — Claude adapta su output a cada persona sin que tengas que explicarlo cada vez.',
        },
      ],
    },
    {
    ...
    {
      type: 'concept',
      title: 'Archivo 3: Decisiones tomadas — el que ahorra más fricción en proyectos',
      body: 'Cada vez que Claude no sabe tus decisiones previas, puede proponerte cambiar de stack, sugerirte una librería que ya descartaste o preguntarte por qué no usas otra herramienta. Un archivo de decisiones tomadas elimina esa fricción. Formato ideal: una lista de declaraciones cortas y definitivas. "Usamos pnpm. El framework es Next.js 15, no vamos a cambiar. Auth con Clerk — Supabase Auth fue evaluado y descartado. CSS con Tailwind, sin CSS-in-JS. Deployment en Vercel, no AWS." Claude trata estas líneas como restricciones inamovibles, no como preferencias que puede cuestionar.',
      highlight: 'La señal de que necesitas este archivo: cuando Claude te dice "¿has considerado usar X en lugar de Y?" sobre algo que llevas meses decidido. Ese momento de fricción es exactamente lo que este archivo elimina.',
    },
    {
      type: 'concept',
      title: 'Archivo 4: Anti-metas — las restricciones que definen tu proyecto tanto como los objetivos',
      body: 'Los objetivos dicen qué quieres lograr. Las anti-metas dicen qué no quieres que pase en el camino. Son igualmente importantes y raramente se documentan. Ejemplos de anti-metas reales: "No agregues dependencias nuevas sin preguntarme primero — el bundle size ya es crítico." "No generes código con comentarios en inglés si el proyecto está en español." "No propongas refactoring cuando solo pido un fix puntual." "No uses guiones em en ningún texto dirigido al cliente." "No hagas setup de tests unitarios — usamos solo tests de integración." Sin este archivo, Claude optimiza para lo que tú pides, pero puede cruzar líneas que nunca mencionaste.',
      highlight: 'Diferencia clave con Anti-AI Writing: ese archivo es sobre estilo de escritura. Las anti-metas son sobre restricciones de proyecto, proceso y comportamiento. Son dos archivos distintos con propósitos distintos.',
    },
    {
      type: 'concept',
      title: 'Archivo 5: Stakeholders — para trabajo en equipo y clientes recurrentes',
      body: 'Si trabajas con otras personas o tienes clientes que aparecen frecuentemente en tus conversaciones con Claude, un archivo de stakeholders le da el contexto que necesita para adaptar su output sin que lo repitas cada vez. Formato: nombre, rol, contexto relevante, preferencias de comunicación. "María López — CEO, toma decisiones de negocio, necesita ver ROI y riesgo, no detalles técnicos. Comunicación: directa, sin rodeos." "Equipo de diseño — 3 personas, usan Figma, necesitan specs en formato Handoff, no código." "Cliente Banco X — muy conservador en tecnología, requiere toda documentación en español formal, sin anglicismos." Claude puede entonces adaptar automáticamente un email, un informe o una propuesta a cada audiencia sin que expliques quiénes son.',
      highlight: 'Este archivo multiplica su valor con el tiempo. Al principio añades 2-3 personas. Después de 6 meses tienes documentado el mapa completo de tu universo profesional — y Claude lo maneja solo.',
    },
    {
      type: 'concept',
...
export const AI_SAFETY_LESSON = {
  ...
  content: [
    ...
    {
      type: 'concept',
      title: 'La Constitución de Claude: el documento que define sus límites',
      body: 'Anthropic publica "La Constitución de Claude" — un documento público que describe explícitamente los valores que Claude debe tener y cómo debe resolver conflictos entre ellos. La jerarquía de valores es: Seguridad (no causar daño catastrófico) → Ética (actuar correctamente como agente moral) → Lineamientos de Anthropic (cumplir las políticas específicas de la empresa) → Utilidad (ser genuinamente útil al usuario). Cuando hay conflicto, la seguridad gana sobre la utilidad. Cuando Claude rechaza algo, está siguiendo esta jerarquía — no es caprichoso ni arbitrario.',
      highlight: 'La Constitución es un documento público que puedes leer en anthropic.com. Entenderla te da perspectiva sobre por qué Claude toma ciertas decisiones — y te quita la frustración de intentar "convencer" a Claude de saltarse algo que está fundamentado en sus valores core.',
    },
    {
      type: 'concept',
      title: 'El sistema de principales: Anthropic → Operador → Usuario',
      body: 'Claude opera dentro de una jerarquía de tres niveles. Anthropic es el nivel más alto: define los límites absolutos a través del entrenamiento y la Constitución. El Operador es quien construye una app vía API (una empresa que crea un chatbot de soporte, por ejemplo): puede personalizar el comportamiento de Claude dentro de los límites de Anthropic. El Usuario eres tú en claude.ai o en cualquier app: puedes influir en el comportamiento dentro de lo que el Operador permite.\n\nClaude trata las instrucciones del operador como un empleador confiable pero no incondicional. Sigue las instrucciones del operador sin necesitar justificación para cada una — igual que un empleado nuevo sigue las políticas de la empresa — pero no si esas instrucciones requieren dañar al usuario o cruzar los límites de Anthropic.',
      highlight: 'Consecuencia práctica: si Claude te rechaza algo en claude.ai, puede ser un comportamiento softcoded que está activo por defecto en ese contexto. Una app construida sobre la API con configuración de operador diferente puede permitir ese mismo request. La jerarquía explica por qué claude.ai se comporta diferente a una app personalizada.',
    },
    {
      type: 'concept',
      title: 'Hardcoded vs softcoded: qué nunca cambia y qué sí puede cambiar',
