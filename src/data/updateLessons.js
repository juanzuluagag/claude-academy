...
export const CCA_LESSON = {
  ...
  content: [
    ...
    {
      type: 'concept',
      title: 'El ecosistema CCA en 2026: Clak, partners y el mercado que te espera',
      body: 'El programa de certificación creció significativamente desde su lanzamiento en marzo 2026:\n\n**Clak — la plataforma de aprendizaje oficial ($100M)**\nAnthropic lanzó Clak como la plataforma oficial de training para el ecosistema de partners. Recibió $100M en inversión para construir rutas de aprendizaje estructuradas, laboratorios prácticos, y el sistema de exámenes de certificación. Si Anthropic Academy (anthropic.skilljar.com) era el acceso gratuito básico, Clak es el tier profesional con contenido avanzado.\n\n**Los 4 anchor partners que validan el mercado**\nAccenture, Deloitte, Cognizant e Infosys son los primeros socios enterprise del programa. Están entrenando activamente a miles de empleados para obtener la CCA — no como ejercicio teórico, sino porque sus clientes corporativos están exigiendo equipos certificados en Claude para proyectos de implementación.\n\n**El equipo del programa creció 5x**\nEl Claude Partner Network pasó de un equipo pequeño a una operación enterprise. Eso se traduce en más recursos de preparación, soporte más rápido, y un roadmap de certificaciones más ambicioso.\n\n**Roadmap de certificaciones (anunciado, fechas por confirmar)**\n• CCA Foundations — disponible ahora\n• Claude Certified Seller — para equipos de ventas que venden soluciones basadas en Claude\n• Claude Certified Developer — tier técnico más avanzado que Foundations\n• Claude Certified Advanced Architect — nivel experto para arquitecturas enterprise complejas\n\n**Por qué importa para tu carrera**\nClaude Code genera más de $2.5B en ARR anualizado. No es un experimento — es infraestructura productiva. Las empresas que lo implementan buscan personas que puedan garantizar que esa infraestructura funciona correctamente. La CCA es la señal más directa de que eres esa persona.',
      highlight: 'Ventana de oportunidad: ser de los primeros en obtener la CCA en Latinoamérica tiene valor de señalización adicional. El ecosistema de implementadores certificados es pequeño y la demanda va por delante de la oferta. Cada nuevo proyecto de Claude en una empresa grande es una oportunidad para alguien con la credencial.',
    },
  ],
  quiz: [
    {
