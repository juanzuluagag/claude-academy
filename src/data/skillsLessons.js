...
export const SKILLS_LESSONS = [
...

  {
    ...
    content: [
      ...
      {
        type: 'concept',
        title: 'Claude for Small Business — 15 Skills + 15 workflows agénticos (13 may 2026)',
        body: 'El 13 de mayo de 2026 Anthropic lanzó Claude for Small Business como toggle dentro de CoWork — sin costo adicional al plan estándar. Daniela Amodei, presidenta de Anthropic, lo resumió en el lanzamiento: "AI is the first technology that can finally close that gap for small businesses."\n\nLo que incluye:\n• 15 Skills prebuilt para áreas de negocio: finanzas, marketing, operaciones y atención al cliente\n• 15 workflows agénticos listos para activar — cada uno encadena múltiples Skills para completar tareas de múltiples pasos sin intervención manual\n• Conectores incluidos sin configuración adicional: QuickBooks, PayPal, HubSpot, Canva, DocuSign, Google Workspace y Microsoft 365\n\nCómo activarlo: en CoWork, busca el toggle "Small Business" en el panel de configuración. Una vez activo, las 15 Skills aparecen en tu biblioteca y puedes activar cualquier workflow desde la interfaz sin tocar la API.',
        highlight: 'Para tu negocio de fotografía: el workflow de "Facturación y cobros" conecta QuickBooks + DocuSign + PayPal — genera la factura, la envía para firma digital, y registra el pago automáticamente. El workflow de "Atención al cliente" conecta tu email (Google Workspace) con HubSpot para seguimiento de leads. Son workflows que antes requerían Zapier + configuración manual.',
      },
      {
        type: 'concept',
