...
export const TECH_STACK_LESSON = {
  ...
  content: [
    ...
    {
      type: 'concept',
      title: 'Actualizaciones del stack 2026: modelos, APIs y créditos',
      body: 'Tres cambios importantes al stack de producción desde mayo 2026:\n\n**Modelo recomendado: claude-opus-4-8 (28 may 2026)**\nEs el modelo más capaz para tareas de producción en la API. Precio estándar: $15/$75 por millón de tokens (input/output). Para proyectos nuevos, reemplaza a claude-opus-4 en todos los endpoints.\n\n**Fast Mode API (28 may 2026)**\nUn segundo tier de velocidad/precio: `speed: "fast"` en el body del request. Precio: $10/$50 por millón de tokens. Ideal para features con latencia sensible (autocompletado, sugerencias en tiempo real, chat de soporte). Para tareas complejas como análisis de portafolio o generación de galerías, sigue usando el modo estándar.\n\n**Mid-conversation System Messages**\nLa Messages API ahora permite inyectar un nuevo system prompt en mitad de una conversación sin romper el hilo. Útil en apps multi-paso: empiezas con un system prompt genérico y lo reemplazas cuando el usuario entra al flujo de "subir fotos de boda" con instrucciones específicas de ese contexto.\n\n**Claude Platform en AWS (11 may 2026)**\nAlternativa enterprise al deployment estándar en Vercel: Claude Platform on AWS permite alojar todo el stack — incluyendo los modelos y los datos — dentro de tu propia cuenta de AWS. Para portales con clientes corporativos que requieren que los datos no salgan de su región, esta arquitectura cumple los requisitos sin sacrificar las capacidades de Claude.\n\n**Separación de créditos: interactive vs programmatic (desde 15 jun 2026)**\nAnthropic divide los créditos en dos pools: Interactive (para claude.ai, Projects, apps de usuario final) y Programmatic (para llamadas a la API, Claude Code, pipelines automatizados). Ya no compiten. Si tu app de fotografía hace llamadas a la API mientras tú usas claude.ai para otras tareas, los dos pools son independientes.',
      highlight: 'Para el Proyecto 9.3: usa claude-opus-4-8 en el endpoint principal del portal. Para el chat de soporte al cliente, activa speed: "fast" — responde más rápido y cuesta 33% menos. Desde junio 2026, el pool programático de tu cuenta no compite con tus créditos interactivos.',
    },
  ],
  quiz: [
    {
